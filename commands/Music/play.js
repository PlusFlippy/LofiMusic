...
const avalynn1 = ['English lofi song 2021', '1 hours english lofi song', 'Top Hit english lofi song', 'english lofi song study', 'english lofi song sleep/relax', 'english lofi song collection', 'aesthetic english lofi reverb song', 'english lofi slowed song'];

  let eng = avalynn1[Math.floor(Math.random() * avalynn1.length)];
...
const avalynn2 = ['hindi lofi songs', 'hindi lofi song sleep/relax', 'hindi lofi song study', 'hindi lofi slowed song', 'hindi lofi song collection', 'aesthetic hindi lofi reverb song', 'romantic lofi hindi song'];
  let hin = avalynn2[Math.floor(Math.random() * avalynn2.length)];  
...
const avalynn3 = ['spanish lofi songs', 'spanish lofi song sleep/relax', 'spanish lofi song study', 'spanish lofi slowed song', 'spanish lofi song collection', 'aesthetic spanish lofi reverb song'];
  let spa = avalynn3[Math.floor(Math.random() * avalynn3.length)];
        args = `${spa}`;
        const searchString = args
        const url = args ? args.replace(/<(.+)>/g, '$1') : '';
  ...
  const dispatcher = queue.connection.play(ytdl(song.url, { highWaterMark: 1 << 20, quality: "highestaudio" }))
         ...
         if(b.id == "nepali") {
          ...
          if (!channel) return await b.reply.send('You need to be in voice channel', true); 
  const avalynn4 = ['nepali lofi songs', 'nepali lofi song sleep/relax', 'nepali lofi song study', 'nepali lofi slowed song', 'nepali lofi song collection', 'aesthetic nepali lofi reverb song'];
  let nep = avalynn4[Math.floor(Math.random() * avalynn4.length)];
